...
RUN apk add bash bash-completion sudo shadow nodejs nodejs-npm git tar gzip less make g++ linux-headers curl bind-tools docker openssh util-linux samba samba-common-tools supervisor && rm -rf /var/cache/apk/*
