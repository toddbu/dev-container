...
RUN apk add bash bash-completion sudo shadow nodejs nodejs-npm git less make g++ linux-headers curl bind-tools docker openssh samba samba-common-tools supervisor && rm -rf /var/cache/apk/*
